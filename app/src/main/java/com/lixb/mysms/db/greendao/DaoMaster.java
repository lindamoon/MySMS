...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        DoHistoryDao.createTable(db, ifNotExists);
        PlanDao.createTable(db, ifNotExists);
        RepeatTaskInfoDao.createTable(db, ifNotExists);
        TargetDao.createTable(db, ifNotExists);
        TaskDao.createTable(db, ifNotExists);
        TaskCommentDao.createTable(db, ifNotExists);
        UserDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        DoHistoryDao.dropTable(db, ifExists);
        PlanDao.dropTable(db, ifExists);
        RepeatTaskInfoDao.dropTable(db, ifExists);
        TargetDao.dropTable(db, ifExists);
        TaskDao.dropTable(db, ifExists);
        TaskCommentDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(DoHistoryDao.class);
        registerDaoClass(PlanDao.class);
        registerDaoClass(RepeatTaskInfoDao.class);
        registerDaoClass(TargetDao.class);
        registerDaoClass(TaskDao.class);
        registerDaoClass(TaskCommentDao.class);
